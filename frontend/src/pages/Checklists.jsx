...
import { checklistService, shiftService, teamService, taskService, userService } from '../services/api'
...
export default function Checklists() {
  ...
  const loadData = async () => {
    try {
      const [checklistsRes, shiftsRes, teamsRes, tasksRes, usersRes] = await Promise.all([
        checklistService.getAll(), shiftService.getAll(), teamService.getAll(), taskService.getAll(), userService.getAll()
      ])
          ...
          <div key={checklist.id} className="card">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">Shift: {checklist.shiftName || 'None'} | Team: {checklist.teamName || 'None'}</p>
              </div>
